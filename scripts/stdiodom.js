...
PrexnsPlunger.prototype.push = function(xmldoc, xmlloader, params) {
	...
	if (sc.substr(1,1) != '0') {
		var scWebdoc = xmlloader.load("../xml/webdocstructure_" + sc + ".xml");
		suzukiNode.appendChild(scWebdoc.documentElement.cloneNode(true));
	}
	if (existsSctnum == 1) {
		var sctWebdoc = xmlloader.load("../xml/webdocstructure_" + sct + "0.xml");
...
function XMLLoader(win) {
	...
	var sourceDoc = "../xml/webdocstructure.xml";
	this.modeMap = {
		"navi": [sourceDoc, "../config8_am/navi-kousei-e.xslt"],
		"navi_dtc": ["../xml/webdocstructure-dtc.xml", "../config8_am/navi-dtc-am.xslt"],
		"navi_sym": ["../xml/webdocstructure-sym.xml", "../config8_am/navi-sym-e.xslt"],
		"navi_sdm": ["../xml/webdocstructure-sdm.xml", "../config8_am/navi-sdm-am.xslt"],
		"search": [sourceDoc, "../config8_am/searchindex-e.xslt"],
		"search_dtc": ["../xml/webdocstructure-dtc.xml", "../config8_am/search-dtc-am.xslt"],
		"search_sym": ["../xml/webdocstructure-sym.xml", "../config8_am/search-sym-e.xslt"],
		"search_sdm": ["../xml/webdocstructure-sdm.xml", "../config8_am/search-sdm-am.xslt"],
		"search_spec": ["../xml/webdocstructure-spec.xml", "../config8_am/search-spec-am.xslt"],
		"modslist": [sourceDoc, "../config8_am/mods-list-e.xslt"],
		"navi_service": ["../xml/webdocstructure-sdm.xml", "../config8_am/navi-sdm-am.xslt"],
		"navi_spec": ["../xml/webdocstructure-spec.xml", "../config8_am/navi-spec-am.xslt"],
		"navi_scan": ["../xml/webdocstructure-scan.xml", "../config8_am/navi-scan-am.xslt"],
		"navi_tool": ["../xml/webdocstructure-tool.xml","../config8_am/navi-ttm.xslt", {"type":"tool"}],
		"navi_torq": ["../xml/webdocstructure-trq.xml","../config8_am/navi-ttm.xslt", {"type": "torque"}],
		"navi_mat": ["../xml/webdocstructure-mtr.xml","../config8_am/navi-ttm.xslt", {"type": "material"}],
		"dtclist": ["../xml/table-dtc.xml", "../config8_am/main-dtc.xslt"],
		"sdmlist": ["../xml/table-sdm.xml", "../config8_am/main-sdm.xslt"],
		"speclist": ["../xml/table-spec.xml", "../config8_am/main-spec.xslt"],
		"scanlist": ["../xml/table-scan.xml", "../config8_am/main-scan.xslt"],
		"toollist": ["../xml/webdocstructure-tool.xml" , "../config8_am/main-ttm.xslt"],
		"torquelist": ["../xml/webdocstructure-trq.xml", "../config8_am/main-ttm.xslt"],
		"materiallist": ["../xml/webdocstructure-mtr.xml", "../config8_am/main-ttm.xslt"]			
	};
	this.injectors = [
		new NodeInjector("main-dtc.xslt",
						 new Plunger(["intxref","intxrefpoff"],
									 function(e) { //document finder
										 return "../xml/webdocstructure_"+ e.getAttribute("id").substring(9,11) + ".xml";
									 },
		...
		new NodeInjector("mods-list-e.xslt",
						 new Plunger("b",
									 function (e) {
										 return "../xml/webdocstructure_" + e.parentNode.getAttribute("f").substring(9,11) + ".xml";
									 },
...
XMLLoader.prototype.loadWebdocVars2 = function() {
	return this.__loadWebDoc("../xml/webdocstructure_vars2.xml");
}

XMLLoader.prototype.loadWebdocVars1 = function() {
	var vars_code = this.__loadWebDoc("../xml/webdocstructure_vars1.xml"); // ex:var strSieIdList = "(\w+?,?)";
...
function getInnerNaviHtml(id) { 
	...
	var subDocPath = "../xml/webdocstructure_" + id + ".xml";
